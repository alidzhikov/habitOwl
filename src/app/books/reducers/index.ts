...
import * as fromSearch from '@howl/books/reducers/search.reducer';
import * as fromBooks from '@howl/books/reducers/books.reducer';
import * as fromCollection from '@howl/books/reducers/collection.reducer';
